...
export const AUFMASS_FIELDS = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'Teilung',
    type: 'enum',
    options: Object.freeze(['einteilig', 'mehrteilig', '—']),
    default: '—',
    reasonKey: 'teilung',
    aliases: Object.freeze({
      geteilt: 'mehrteilig',
      zweiteilig: 'mehrteilig',
      dreiteilig: 'mehrteilig',
      zweiflügelig: 'mehrteilig',
      zweifluegelig: 'mehrteilig',
      zweiflügel: 'mehrteilig',
      mehrflügelig: 'mehrteilig',
      mehrfluegelig: 'mehrteilig',
      '2teilig': 'mehrteilig',
      '3teilig': 'mehrteilig',
      mitpfosten: 'mehrteilig',
      ungeteilt: 'einteilig',
      einflügelig: 'einteilig',
      einfluegelig: 'einteilig',
      einflügel: 'einteilig',
    }),
  }),
  Object.freeze({
  ...
  Object.freeze({ key: 'marke', label: 'Marke/Profil', type: 'text', default: '', maxLen: 100 }),
  Object.freeze({
    key: 'verglasung',
    label: 'Verglasung',
    type: 'enum',
